...
public class RiddleParser extends Parser {
	...
	public static final int
		...
		Private=24, Virtual=25, Operator=26, Template=27, TypeName=28, Int_=29, 
		Float_=30, Double_=31, Short_=32, Long_=33, Char_=34, LeftBracket=35, 
		RightBracket=36, LeftSquare=37, RightSquare=38, LeftCurly=39, RightCurly=40, 
		Colon=41, Semi=42, Comma=43, Equal=44, Assign=45, Greater=46, Less=47, 
		LeftLeft=48, RightRight=49, RightRightRight=50, Add=51, Sub=52, Star=53, 
		Div=54, Mod=55, Not=56, And=57, Or=58, Xor=59, Dot=60, DoubleQuotes=61, 
		Quotes=62, Endl=63, Identifier=64, Hexadecimal=65, Decimal=66, Octal=67, 
		Binary=68, Float=69, IntegerSequence=70, HEX_DIGIT=71, OCTAL_DIGIT=72, 
		BINARY_DIGIT=73, DIGIT=74, STRING=75, CHAR=76, LINE_COMMENT=77, BLOCK_COMMENT=78, 
		WHITESPACE=79;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"Private", "Virtual", "Operator", "Template", "TypeName", "Int_", "Float_", 
			"Double_", "Short_", "Long_", "Char_", "LeftBracket", "RightBracket", 
			...
			"Or", "Xor", "Dot", "DoubleQuotes", "Quotes", "Endl", "Identifier", "Hexadecimal", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -9135405986765603078L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 6207L) != 0)) {
					{
					{
					setState(76);
					statement_ed();
	...
	public final ArgsExprContext argsExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 6988466090483384327L) != 0)) {
				{
				setState(153);
				_errHandler.sync(this);
	...
	public final ForStatementContext forStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -9135410384812114182L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 6207L) != 0)) {
				{
				setState(233);
